...
class EntrepriseDetailsAlert extends StatefulWidget {
  EntrepriseDetailsAlert({Key? key, required this.editer}) : super(key: key);
  VoidCallback editer;

  @override
  State<EntrepriseDetailsAlert> createState() => _EntrepriseDetailsAlertState();
}

class _EntrepriseDetailsAlertState extends State<EntrepriseDetailsAlert>
