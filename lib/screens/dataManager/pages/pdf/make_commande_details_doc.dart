...
Future<Uint8List> generateReportCommandeDetails(
    PdfPageFormat pageFormat, List<Commande> commandes, Client client) async {
    ...
    pw.MultiPage(
        ...
        build: (pw.Context context) => <pw.Widget>[
              ...
              for (Commande commande in commandes) ...{
                ...
                pw.Bullet(text: 'Client : ${client.nomComplet}'),
                pw.Bullet(text: 'Tel : ${client.phone}'),
                pw.Bullet(
                    text:
