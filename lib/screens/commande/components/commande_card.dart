...
import 'package:atelier_so/widgets/PopUps/commande_details.popUp.dart';
      ...
      onTap: () => widget.onSelected != null
          ...
          : {
              showDialog(
                ...
                context: context,
                builder: (_) => CommandeDetailsAlert(
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                detailsLigne(
                                  titre: "N.habits",
                                  data: "${widget.commande.habits?.length}",
                                  dataColor: ThemeColors.greyDeep,
                                  nLigne: 1,
                                  paddingV: 2,
                                ),
