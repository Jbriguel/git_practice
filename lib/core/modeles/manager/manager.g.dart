...
class _$Manager extends Manager {
  ...
  factory _$Manager([void Function(ManagerBuilder)? updates]) =>
      (new ManagerBuilder()..update(updates))._build();
  ...
  _$Manager._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        entrepriseId, r'Manager', 'entrepriseId');
    BuiltValueNullFieldError.checkNotNull(role, r'Manager', 'role');
    BuiltValueNullFieldError.checkNotNull(createdAt, r'Manager', 'createdAt');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Manager')
...
class ManagerBuilder implements Builder<Manager, ManagerBuilder> {
  _$Manager? _$v;
